            ...
            <div class="columns">
                ...
                <div class="column is-10">
                    <p class="heading-title">
                        <strong>No engines detected this file</strong>
                    </p>
                    <div class="columns">
                        <div class="column is-2 no-padding-top"><strong>SHA-256</strong></div>
                        <div class="column is-10 no-padding-top">2b9f3f2dced3b0cfb37529f3faa1f76b73b58a5287e65308a87be992b391bc6a</div>
                    </div>
                    <div class="columns">
                        <div class="column is-2 no-padding-top"><strong>File name</strong></div>
                        <div class="column is-10 no-padding-top">Ionic-App.txt</div>
                    </div>
                    <div class="columns">
                        <div class="column is-2 no-padding-top"><strong>File size</strong></div>
                        <div class="column is-10 no-padding-top">855 B</div>
                    </div>
                    <div class="columns">
                        <div class="column is-2 no-padding-top"><strong>Last analysis</strong></div>
                        <div class="column is-10 no-padding-top">2018-02-18 12:35:06 UTC</div>
                    </div>
                </div>
            </div>
        </div>
