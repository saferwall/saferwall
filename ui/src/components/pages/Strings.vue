            ...
            <div class="tile is-parent">
                <div class="tile is-child box">
                    <table class="table is-bordered is-striped">
                        <thead style="display:block;position:sticky;top:50px;background: #fff">
                            <tr>
                                <th>
                                    <div class="head-title">Encoding</div>
                                    <div class="sort-icons">
                                        <i class="icon ion-arrow-up-b up" @click="sortTable('asc', 'encoding')"></i>
                                        <i class="icon ion-arrow-down-b down" @click="sortTable('desc', 'encoding')"></i>
                                    </div>
                                </th>
                                <th>
                                    <span class="head-title">Value</span>
                                    <div class="sort-icons">
                                        <i class="icon ion-arrow-up-b up" @click="sortTable('asc', 'value')"></i>
                                        <i class="icon ion-arrow-down-b down" @click="sortTable('desc', 'value')"></i>
                                    </div>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="control">
                                        <input class="input" @keyup="search('encodings')" v-model="encodingSearched" type="text" placeholder="Search Encodings...">
                                    </div>
                                </td>
                                <td>
                                    <div class="control">
                                        <input class="input" @keyup="search('values')" v-model="valueSearched" type="text" placeholder="Search Values...">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
