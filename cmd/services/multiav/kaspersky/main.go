...
import (
	...
	"github.com/saferwall/saferwall/internal/multiav/kaspersky"
...
var flagConfig = flag.String(
	"config", "./../../../../configs/services/multiav/kaspersky",
...
func run(logger log.Logger) error {
	...
	logger.Infof("Starting kesl daemon")
	if err = kaspersky.StartDaemon(); err != nil {
		return err
	}
